...
export const translations = {
  ...
  it: {
    ...
    premium: {
      ...
      subtitle: "Il dossier definitivo per i competitor d'élite",
      feature1: "MATRICE PSICOMETRICA COMPLETA",
      desc1: "Analisi profonda dei tuoi 5 tratti neurali con posizionamento globale.",
      feature2: "VETTORI DI OTTIMIZZAZIONE",
      desc2: "Consigli personalizzati per migliorare performance meccaniche e mentali.",
      feature3: "CERTIFICAZIONE UFFICIALE",
      desc3: "Certificato di Identità Neurale unico (DNA-CERT) per il reclutamento.",
    ...
    howItWorks: {
      ...
      ego: "EGO",
      egoDesc: "Livelli di dominanza e sicurezza nei match ad alta pressione.",
      clutch: "CLUTCH",
      clutchDesc: "Precisione di esecuzione durante scenari critici di fine round.",
      toxic: "TOXIC",
      toxicDesc: "Attrito neurale e impatto psicologico sulle dinamiche di team.",
      tactics: "TACTICS",
      tacticsDesc: "Capacità di macro-game e indice di posizionamento spaziale.",
      resil: "RESIL",
      resilDesc: "Capacità di mantenere performance di picco dopo sconfitte consecutive.",
    },
    cta: {
