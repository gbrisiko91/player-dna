...
import { CheckCircle2, Download, Loader2, Share2, ShieldCheck } from "lucide-react";
        ...
        {status === "loading" ? (
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
              <button className="group relative py-6 bg-white text-black font-esports text-sm tracking-widest uppercase hover:bg-dna-neon transition-all flex items-center justify-center gap-3">
