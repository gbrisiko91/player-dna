    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-20 px-4 overflow-hidden the-void">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto flex flex-col items-center text-center">
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8 w-full border-t border-white/5 pt-12">
          <HUDItem icon={<ShieldAlert className="w-5 h-5 text-dna-danger" />} label={t.hero.toxicity} value={t.hero.active} />
          <HUDItem icon={<Cpu className="w-5 h-5 text-dna-neon" />} label={t.hero.neural} value={t.hero.ready} />
          <HUDItem icon={<Zap className="w-5 h-5 text-dna-purple" />} label={t.hero.clutch} value={t.hero.calibrating} />
        </div>
      </div>
    </section>
  );
